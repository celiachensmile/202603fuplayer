...
function calcStats(rows) {
  ...
  return {
    ...
    summaryCards: {
      ...
      avgInterest: avgScale('q9'),
      interestedPct: Math.round(interestedCount / total * 100),
      topPrice: topVal('q15')
    },
    charts: {
      q1: countSingle('q1'), q4: countSingle('q4'), q5: countSingle('q5'),
      q6: countSingle('q6'), q7: countMulti('q7'), q8: countMulti('q8'),
      q9: countSingle('q9'), q10: countMulti('q10'), q12: countSingle('q12'),
      q13: countMulti('q13'), q14: countMulti('q14'), q15: countSingle('q15'),
      q16: countMulti('q16'), q17: countSingle('q17'), q18: countMulti('q18')
    },
    crossAnalysis: {
      ageInterest: crossSingle('q1', 'q9'),
      ageConcern: crossMultiA('q1', 'q7'),
      rolePrice: crossMultiA('q2', 'q15'),
      aiInterest: crossSingle('q5', 'q9'),
      moodObstacle: crossMultiA('q6', 'q10')
    }
  };
}
